...
class RecentArticlesFragment : Fragment() {
    ...
    private lateinit var recentArticlesRecView: RecyclerView
    private lateinit var recentArticles: ArrayList<Article>
    private lateinit var recentArticlesAdapter: ArticleAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recentArticlesRecView = view.findViewById(R.id.recentArticlesRecView)
        recentArticlesRecView.layoutManager = LinearLayoutManager(requireContext())
        recentArticles = arrayListOf()
        recentArticlesAdapter = ArticleAdapter(requireContext(), recentArticles)
        recentArticlesRecView.adapter = recentArticlesAdapter
    ...
    private fun fetchRecentArticles() {
        ...
        db.collection("articles").get()
            .addOnSuccessListener { querySnapshot ->
                ...
                recentArticles.sortByDescending { it.publishedOn }
